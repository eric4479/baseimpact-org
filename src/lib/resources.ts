...
export const BREVARD_RESOURCES: Resource[] = [
  ...
  },
  {
    ...
    phone: "(321) 383-0254",
    description:
      "Hot meals, clothing, blankets, and cold night shelter. Sunday worship, Monday evening outreach, and Thursday free meal/showers/hygiene care.",
    hoursText: "Sun 10:30 AM; Mon 4:00 PM–8:30 PM; Thu 4:30 PM–6:30 PM; call for current schedule",
    schedule: { 0: [10.5, 11.5], 1: [16, 20.5], 4: [16.5, 18.5] },
    tags: ["Hot Meals", "Clothing", "Shelter", "Showers", "Hygiene", "North Brevard", "Faith-Based"],
    partnerType: "Faith Partner",
