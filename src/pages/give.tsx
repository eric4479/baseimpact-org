    ...
    <div className="space-y-10">
      ...
      <section id="give-directly" className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          {PARTNERS.map((p) => (
            <article key={p.name} className="rounded-2xl bg-card p-5 shadow-[var(--shadow-border)]">
              ...
              <p className="mt-1 text-xs text-muted">{p.addr}</p>
            </article>
          ))}
        </div>
        <p>
          <Link to="/directory" className="font-semibold text-accent underline-offset-2 hover:underline">
            See full directory →
          </Link>
        </p>
      </section>
      ...
      <section id="give-goods" className="space-y-4">
        ...
        <ul className="grid grid-cols-1 gap-2 sm:grid-cols-2">
          {HIGH_PRIORITY.map((item) => (
            <li key={item} className="rounded-xl bg-card px-4 py-3 text-sm shadow-[var(--shadow-border)]">
              {item}
            </li>
          ))}
        </ul>
      ...
      <section id="give-time" className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <article className="rounded-2xl bg-card p-5 shadow-[var(--shadow-border)]">
            ...
            <p className="mt-1 text-sm font-semibold text-accent">Mon, Wed, Fri 1–5 PM</p>
      ...
      <section className="rounded-3xl bg-inset px-5 py-8 sm:p-8">
        ...
        <p className="mt-3 max-w-2xl text-muted">
          ...
          <Link to="/about" className="font-semibold text-accent underline-offset-2 hover:underline">
            about page
          </Link>
          .
        </p>
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted">We&apos;d rather you ask first. No pressure.</p>
