  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <header className="space-y-2">
        ...
        <p className="text-ink-soft">Last updated: September 25, 2026</p>
      </header>

      <div className="rounded-2xl bg-paper-sunken p-5 text-sm text-ink sm:p-6">
      ...
      <section className="space-y-5 rounded-2xl bg-paper-raised p-5 shadow-[var(--shadow-border)] sm:p-6">
        <div>
